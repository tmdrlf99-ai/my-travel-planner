// MY TRAVEL PLANNER v5.9 - Vercel same-origin sync proxy
...
const SUPABASE_KEY = process.env.SUPABASE_PUBLISHABLE_KEY || "sb_publishable_7RaNiiyEa6XuDZzAgyO5Jg_uDI-l5hj";
...
module.exports = async function handler(req,res){
  ...
  try{
    ...
    return res.status(502).json({error:err.message||"동기화 서버 오류"});
  }
};
